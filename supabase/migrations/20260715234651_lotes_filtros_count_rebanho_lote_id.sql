-- A quantidade exibida na pagina principal de lotes vem exclusivamente do
-- vinculo atual em rebanho: loteID + idPropriedade.
-- lotes.id_animais nao faz parte do retorno nem da contagem desta funcao.
  ...
  lotes_com_contagem AS (
    SELECT
      ...
      (
        ...
        WHERE r."loteID" = lf.id_lote
          AND r."idPropriedade" = lf.id_propriedade
          AND r.deletado = 'NAO'
      ) AS qtd_rebanhos_no_lote,
      CASE
