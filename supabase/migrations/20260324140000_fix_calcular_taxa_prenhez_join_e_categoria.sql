-- Corrige calcular_taxa_prenhez: INNER JOIN + filtro só em rebanho.categoria zerava o resultado.
-- Usa LEFT JOIN, categorias de reproducao.categoria com fallback para rebanho, e bucket "Outras".
