-- Lista de lotes: qtd_rebanhos_no_lote alinhada à visualização do lote.
-- Antes só contava por rebanho.loteNome = lotes.nome; import por planilha costuma
-- preencher só loteID, e pg_view_lote conta por loteID OU loteNome.
