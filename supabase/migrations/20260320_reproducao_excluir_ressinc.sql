-- =============================================================================
-- Migration: Excluir registros com ressinc = 'SIM' nas RPCs de reprodução
-- Alinha o count do servidor com as linhas visíveis na tabela do cliente.
-- =============================================================================

-- 1. reproducao_filtros
