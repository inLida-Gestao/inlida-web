-- Melhoria #14: Filtro "Sem lote" para animais sem lote atribuído.
-- Quando p_lote_nome = 'SEM_LOTE', retorna apenas animais sem lote.
...
-- Also update the count function (uses p_lote_id, not p_lote_nome)
