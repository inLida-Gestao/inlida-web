-- Correção: KPI Taxa de desmama por período.
-- Denominador: animais (tipo animal) com dataNascimento dentro do período filtrado.
-- Numerador: dos animais do denominador, contar os que possuem dataDesmama OU
--            pesoDesmama preenchido — SEM filtrar a data de desmama pelo período.
-- Fórmula: (total_desmamados / total_animais) * 100, arredondado 2 casas.
