-- Taxa de concepcao (painel): denominador = eventos/registros de reproducao
-- com data_inseminacao no periodo. Nao agrupar por matriz aqui; a taxa por
-- matrizes distintas fica em calcular_taxa_prenhez2.
...
COMMENT ON FUNCTION public.calcular_taxa_prenhez(text, text, text, text, text, text) IS
  'Taxa de concepcao por categoria: prenhes (status prenhe*) / eventos de reproducao com data_inseminacao no periodo.';
