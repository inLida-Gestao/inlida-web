                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              StreamBuilder<List<CidadesRow>>(
                                                stream: _model
                                                        .dropDownCidadeSupabaseStream ??=
                                                    SupaFlow.client
                                                        .from("cidades")
                                                        .stream(
                                                            primaryKey: ['id'])
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              FuncaoUserWidget(
                                                                key: Key(
                                                                    'Keyl23_${userPropIndex}_of_${userProp.length}'),
                                                                userID:
                                                                    userPropItem
                                                                        .userId,
                                                                funcao: userPropItem
                                                                      ...
                                                                      await showDialog<
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return AlertDialog(
                                                                                ...
                                                                                content: const Text('Deseja remover este usuário da propriedade?'),
                                                                                actions: [
                                                                                  TextButton(
                          ...
                          if (_model.usersPropriedade != null &&
                            ...
                            await PropriedadesTable().update(
                              ...
                              matchingRows: (rows) => rows.eqOrNull(
                                'idPropriedade',
                                containerPropriedadesRow?.idPropriedade,
                              ),
                            );
                          } else {
                            await PropriedadesTable().update(
