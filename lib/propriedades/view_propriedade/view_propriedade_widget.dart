...
import 'view_propriedade_model.dart';
export 'view_propriedade_model.dart';

class ViewPropriedadeWidget extends StatefulWidget {
  const ViewPropriedadeWidget({super.key});

  @override
  State<ViewPropriedadeWidget> createState() => _ViewPropriedadeWidgetState();
}

class _ViewPropriedadeWidgetState extends State<ViewPropriedadeWidget>
    with TickerProviderStateMixin {
  late ViewPropriedadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewPropriedadeModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: StreamBuilder<List<PropriedadesRow>>(
        stream: _model.containerSupabaseStream ??= SupaFlow.client
            ...
            .map((list) => list.map((item) => PropriedadesRow(item)).toList()),
        builder: (context, snapshot) {
          ...
          List<PropriedadesRow> containerPropriedadesRowList = snapshot.data!;

          final containerPropriedadesRow =
              containerPropriedadesRowList.isNotEmpty
                  ? containerPropriedadesRowList.first
                  : null;
                          ...
                          child: TabBarView(
                            ...
                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      valueOrDefault<String>(
                                                        ((containerPropriedadesRow!.areaAgricultura!) +
                                                                (containerPropriedadesRow
                                                                    .areaBenfeitoria!) +
                                                                (containerPropriedadesRow
                                                                    .areaReserva!) +
                              ...
                              StreamBuilder<List<UsersPropriedadesRow>>(
                                stream: _model.containerUsersSupabaseStream ??=
                                    SupaFlow.client
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UsersPropriedadesRow>
                                      containerUsersUsersPropriedadesRowList =
                                      snapshot.data!;
                                                  ...
                                                  onPressed: () async {
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          content: const Text(
                                                              'Para adicionar novos usuários cliente no botão para Editar'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                          ...
                                          Builder(
                                            builder: (context) {
                                              ...
                                              return ListView.builder(
                                                ...
                                                itemCount: userProp.length,
                                                itemBuilder:
                                                    (context, userPropIndex) {
                                                  final userPropItem =
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              FuncaoUserWidget(
                                                                key: Key(
                                                                    'Keyrzu_${userPropIndex}_of_${userProp.length}'),
                                                                userID:
                                                                    userPropItem
                                                                        .userId,
                                                                funcao: userPropItem
