...
class _FiltroPropriedadesWidgetState extends State<FiltroPropriedadesWidget> {
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: FutureBuilder<List<PropriedadesRow>>(
        future: PropriedadesTable().queryRows(
          queryFn: (q) => q.or(
              "userID.eq.$currentUserUid, usersID.like.$currentUserUid"),
        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              options: containerPropriedadesRowList
                              ...
                              onChanged: (val) async {
                                safeSetState(
                                    () => _model.dropDownCidadeValue = val);
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              onMultiSelectChanged: (val) async {
                                ...
                                FFAppState().filtroAtividades = _model
