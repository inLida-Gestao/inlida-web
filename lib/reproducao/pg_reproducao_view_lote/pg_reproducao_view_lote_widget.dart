...
import 'pg_reproducao_view_lote_model.dart';
export 'pg_reproducao_view_lote_model.dart';

class PgReproducaoViewLoteWidget extends StatefulWidget {
  const PgReproducaoViewLoteWidget({
    super.key,
  ...
  static String routeName = 'pgReproducaoViewLote';
  static String routePath = '/visualizar-reproducao-lote';

  @override
  State<PgReproducaoViewLoteWidget> createState() =>
      _PgReproducaoViewLoteWidgetState();
}

class _PgReproducaoViewLoteWidgetState
    extends State<PgReproducaoViewLoteWidget> {
  late PgReproducaoViewLoteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgReproducaoViewLoteModel());
