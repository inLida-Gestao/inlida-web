...
import 'pg_reproducao_edit_lote_model.dart';
export 'pg_reproducao_edit_lote_model.dart';

class PgReproducaoEditLoteWidget extends StatefulWidget {
  const PgReproducaoEditLoteWidget({
    super.key,
  ...
  static String routeName = 'pgReproducaoEditLote';
  static String routePath = '/editar-reproducao-lote';

  @override
  State<PgReproducaoEditLoteWidget> createState() =>
      _PgReproducaoEditLoteWidgetState();
}

class _PgReproducaoEditLoteWidgetState
    extends State<PgReproducaoEditLoteWidget> {
  late PgReproducaoEditLoteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgReproducaoEditLoteModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.ressincDropdownValue = _model.reproducao?.firstOrNull?.ressinc;
      _model.gnrhDropdownValue = _model.reproducao?.firstOrNull?.gnrh;
      _model.cioDropdownValue = _model.reproducao?.firstOrNull?.cio;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ReproducaoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReproducaoRow> pgReproducaoEditLoteReproducaoRowList =
            snapshot.data!;

        final pgReproducaoEditLoteReproducaoRow =
            pgReproducaoEditLoteReproducaoRowList.isNotEmpty
                ? pgReproducaoEditLoteReproducaoRowList.first
                : null;
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  ...
                                                  margin: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          12.0, 0.0, 12.0, 0.0),
                                                  hidesUnderline: true,
                                                  disabled: pgReproducaoEditLoteReproducaoRow
                                                              .idReproducao !=
                                                          null &&
                                                      pgReproducaoEditLoteReproducaoRow
                                                              .idReproducao !=
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (!(pgRebanhRebanhoRowList
                                                    ...
                                                    .isNotEmpty))
                                                  Text(
                                                    'Não foi possível encontrar um reprodutor.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                        ...
                                                        await ReproducaoTable()
                                                          ...
                                                          data: {
                                                            ...
                                                            'data_inseminacao': supaSerialize<
                                                                DateTime>(_model
                                                                    .datePicked1 ?? pgReproducaoEditLoteReproducaoRow
                                                                    .dataInseminacao),
                                                            'data_partida_semen': supaSerialize<
                                                                DateTime>(_model
                                                                    .datePicked2 ?? pgReproducaoEditLoteReproducaoRow
                                                                    .dataPartidaSemen),
                                                            'partida_semen':
                                                                _model
                                                                    .partidaSemen,
                                                            ...
                                                            'data_inicial': supaSerialize<
                                                                DateTime>(_model
                                                                    .datePicked3 ?? pgReproducaoEditLoteReproducaoRow
                                                                    .dataInicial),
                                                            'data_final': supaSerialize<
                                                                DateTime>(_model
                                                                    .datePicked4 ?? pgReproducaoEditLoteReproducaoRow
                                                                    .dataFinal),
                                                            'status_reproducao':
                                                                _model
                                                                    .dropDownStatusValue,
                                                            ...
                                                            'data_status': supaSerialize<
                                                                DateTime>(_model
                                                                    .datePicked5 ?? pgReproducaoEditLoteReproducaoRow
                                                                    .dataStatus),
                                                            'numReprodutor':
                                                                pgRebanhRebanhoRowList
                                                                    .where((e) =>
