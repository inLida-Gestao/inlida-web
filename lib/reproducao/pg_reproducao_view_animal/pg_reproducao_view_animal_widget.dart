...
import 'pg_reproducao_view_animal_model.dart';
export 'pg_reproducao_view_animal_model.dart';
...
class PgReproducaoViewAnimalWidget extends StatefulWidget {
  ...
  static String routePath = '/visualizar-reproducao-animal';

  @override
  State<PgReproducaoViewAnimalWidget> createState() =>
      _PgReproducaoViewAnimalWidgetState();
}

class _PgReproducaoViewAnimalWidgetState
    extends State<PgReproducaoViewAnimalWidget> {
  late PgReproducaoViewAnimalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgReproducaoViewAnimalModel());
    ...
    _model.nomeInseminadorTextController ??=
        TextEditingController(text: _model.reproducaoSelecionada?.inseminador);
    ...
    _model.anotacoesTextController ??=
        TextEditingController(text: _model.reproducaoSelecionada?.anotacoes);
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  '${_model.matrizData?.firstOrNull?.numeroAnimal ?? _model.reproducaoSelecionada?.numMatriz ?? 'S/N'} • ${_model.matrizData?.firstOrNull?.nome ?? _model.reproducaoSelecionada?.nomeMatriz ?? 'S/N'}',
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: const Text(
                                                                    'Excluir reprodução'),
                                                                content: const Text(
                                                                    'Deseja realmente excluir esta reprodução? Esta ação é irreversível.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
