...
import '/index.dart';
import 'pg_reproducao_view_animal_widget.dart'
    show PgReproducaoViewAnimalWidget;
import 'package:flutter/material.dart';

class PgReproducaoViewAnimalModel
    extends FlutterFlowModel<PgReproducaoViewAnimalWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pgReproducaoViewAnimal widget.
  List<ReproducaoRow>? reproducao;
  // Stores action output result for [Backend Call - Query Rows] action in pgReproducaoViewAnimal widget.
  List<RebanhoRow>? matrizData;
  // Stores action output result for [Backend Call - Query Rows] action in pgReproducaoViewAnimal widget.
