...
import 'cc_add_semen_model.dart';
export 'cc_add_semen_model.dart';

class CcAddSemenWidget extends StatefulWidget {
  const CcAddSemenWidget({
    super.key,
  ...
  @override
  State<CcAddSemenWidget> createState() => _CcAddSemenWidgetState();
}

class _CcAddSemenWidgetState extends State<CcAddSemenWidget> {
  late CcAddSemenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CcAddSemenModel());
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.numAnimalTextController,
                                focusNode: _model.numAnimalFocusNode,
                                autofocus: false,
                                obscureText: false,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.codRegistroTextController,
                                focusNode: _model.codRegistroFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: false,
