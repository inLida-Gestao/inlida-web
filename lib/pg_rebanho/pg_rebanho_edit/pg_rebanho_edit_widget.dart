...
import 'pg_rebanho_edit_model.dart';
export 'pg_rebanho_edit_model.dart';

class PgRebanhoEditWidget extends StatefulWidget {
  const PgRebanhoEditWidget({
    super.key,
  ...
  static String routeName = 'pgRebanhoEdit';
  static String routePath = '/editrebanho';

  @override
  State<PgRebanhoEditWidget> createState() => _PgRebanhoEditWidgetState();
}

class _PgRebanhoEditWidgetState extends State<PgRebanhoEditWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.disposeRefreshListener =
          FFAppState().onRefresh('refreshAnimalSelecionado', () {
    ...
    _model.dataMovimentacaoFocusNode ??= FocusNode();

    _model.dataMovimentacaoSaidaFocusNode ??= FocusNode();

    _model.dataMorteFocusNode ??= FocusNode();

    _model.dataAcaoFocusNode1 ??= FocusNode();

    _model.dataAcaoFocusNode2 ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RebanhoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RebanhoRow> pgRebanhoEditRebanhoRowList = snapshot.data!;

        final pgRebanhoEditRebanhoRow = pgRebanhoEditRebanhoRowList.isNotEmpty
        ...
        return FutureBuilder<HistoricoPesagensRow?>(
          ...
          builder: (context, desmamaSnapshot) {
            ...
            final effectiveDataDesmamaInicial =
                pgRebanhoEditRebanhoRow?.dataDesmama ??
                    desmamaPesagem?.dataPesagem;
            final effectivePesoDesmamaInicial =
                pgRebanhoEditRebanhoRow?.pesoDesmama ?? desmamaPesagem?.peso;
            ...
            if (pgRebanhoEditRebanhoRow != null &&
              ...
              FFAppState().matrizSelecionada = AnimalSelecionadoStruct(
                ...
                dataNascAnimal:
                    pgRebanhoEditRebanhoRow.dataNascMatriz?.toString(),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextFormField(
                                                                        controller:
                                                                          ...
                                                                          text:
                                                                              pgRebanhoEditRebanhoRow?.numeroAnimal,
                                                                        ),
                                                                        focusNode:
                                                                            _model.numAnimalFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        obscureText:
                                                                            false,
                                                                      ...
                                                                      TextFormField(
                                                                        controller:
                                                                            _model.codRegistroTextController ??=
                                                                                TextEditingController(
                                                                          text:
                                                                              pgRebanhoEditRebanhoRow?.codRegistro,
                                                                        ),
                                                                        focusNode:
                                                                      ...
                                                                      TextFormField(
                                                                        controller:
                                                                            _model.nomeAnimalTextController ??=
                                                                                TextEditingController(
                                                                          text: pgRebanhoEditRebanhoRow?.nome == 'null'
                                                                              ? ''
                                                                              : pgRebanhoEditRebanhoRow?.nome,
                                                                        ),
                                                                        focusNode:
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          hintText: pgRebanhoEditRebanhoRow?.nome == 'null'
                                                                              ? ''
                                                                              : pgRebanhoEditRebanhoRow?.nome,
                                                                          hintStyle: FlutterFlowTheme.of(context)
                                                                              .labelMedium
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          final hasDataNascimento =
                                                                              !_model.dataNascimentoCleared && (_model.datePicked1 != null || rowNasc != null);
                                                                          return Row(
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
                                                                              Expanded(
                                                                                child: Stack(
                                                                                  children: [
                                                                                    TextFormField(
                                                                                      controller: _model.dataNascimentoTextController ??= TextEditingController(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextFormField(
                                                                        ...
                                                                        focusNode:
                                                                            _model.pesoNascimentoFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        obscureText:
                                                                            false,
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      FlutterFlowDropDown<
                                                                        ...
                                                                        onChanged:
                                                                            (val) =>
                                                                                safeSetState(() => _model.dropDownPorteValue = val),
                                                                        height:
                                                                            56.0,
                                                                        textStyle: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDropDown<
                                                                            ...
                                                                            controller: _model.dropDownLotesValueController ??=
                                                                                FormFieldController<String>(
                                                                              _model.dropDownLotesValue ??= pgRebanhoEditRebanhoRow?.loteNome,
                                                                            ),
                                                                            options:
                                                                                dropDownLotesLotesRowList.map((e) => e.nome).withoutNulls.toList(),
                                                                            onChanged: (val) =>
                                                                                ...
                                                                                text: valueOrDefault<String>(
                                                                                  _model.datePicked2 != null
                                                                                      ...
                                                                                      : valueOrDefault<String>(
                                                                                          dateTimeFormat(
                                                                                            "d/M/y",
                                                                                            pgRebanhoEditRebanhoRow?.dataEntradaLote,
                                                                                            locale: FFLocalizations.of(context).languageCode,
                                                                                          ),
                                                                                          'dd/mm/yyyy',
                                                                                        ),
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          final hasDataDesmama =
                                                                              !_model.dataDesmamaCleared && (_model.datePicked3 != null || rowDesm != null);
                                                                          return Row(
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
                                                                              Expanded(
                                                                                child: Stack(
                                                                                  children: [
                                                                                    TextFormField(
                                                                                      controller: _model.dataDesmamaTextController ??= TextEditingController(
                                                                                        text: valueOrDefault<String>(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextFormField(
                                                                        controller:
                                                                          ...
                                                                          text:
                                                                              valueOrDefault<String>(
                                                                            PesoDecimalInputFormatter.formatDouble(effectivePesoDesmamaInicial),
                                                                            '',
                                                                          ),
                                                                        ),
                                                                        focusNode:
                                                                            _model.pesoDesmamaFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        obscureText:
                                                                            false,
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Stack(
                                                                        children: [
                                                                          TextFormField(
                                                                            controller: _model.dataUltimaPesagemTextController ??=
                                                                                TextEditingController(
                                                                              text: valueOrDefault<String>(
                                                                                _model.datePicked4 != null
                                                                                    ...
                                                                                    : valueOrDefault<String>(
                                                                                        dateTimeFormat(
                                                                                          "d/M/y",
                                                                                          pgRebanhoEditRebanhoRow?.dataUltimaPesagem,
                                                                                          locale: FFLocalizations.of(context).languageCode,
                                                                                        ),
                                                                                        'dd/mm/aaaa',
                                                                                      ),
                                                                            ...
                                                                            focusNode:
                                                                                _model.dataUltimaPesagemFocusNode,
                                                                            autofocus:
                                                                                false,
                                                                            readOnly:
                                                                                true,
                                                                            ...
                                                                            cursorColor:
                                                                                FlutterFlowTheme.of(context).primaryText,
                                                                            validator:
                                                                                _model.dataUltimaPesagemTextControllerValidator.asValidator(context),
                                                                          ),
                                                                          InkWell(
                                                                            splashColor:
                                                                                Colors.transparent,
                                                                      ...
                                                                      FlutterFlowDropDown<
                                                                        ...
                                                                        controller:
                                                                          ...
                                                                          _model.dropDownStatusValue ??=
                                                                              pgRebanhoEditRebanhoRow?.status,
                                                                        ),
                                                                        options:
                                                                      ...
                                                                      FlutterFlowDropDown<
                                                                        ...
                                                                        controller:
                                                                          ...
                                                                          _model.dropDownOrigemValue ??=
                                                                              pgRebanhoEditRebanhoRow?.origem,
                                                                        ),
                                                                        options:
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Stack(
                                                                    children: [
                                                                      TextFormField(
                                                                        controller:
                                                                            _model.dataMovimentacaoTextController ??=
                                                                                TextEditingController(
                                                                          text: _model.datePicked5 != null
                                                                              ...
                                                                              : dateTimeFormat(
                                                                                  "d/M/y",
                                                                                  pgRebanhoEditRebanhoRow?.movimentacaoEntrada,
                                                                                  locale: FFLocalizations.of(context).languageCode,
                                                                                ),
                                                                        ),
                                                                        focusNode:
                                                                            _model.dataMovimentacaoFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        readOnly:
                                                                            true,
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          hintText: _model.datePicked5 != null
                                                                              ? dateTimeFormat(
                                                                                  "d/M/y",
                                                                                  _model.datePicked5,
                                                                                  locale: FFLocalizations.of(context).languageCode,
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.dataMovimentacaoTextController?.text =
                                                                                dateTimeFormat(
                                                                              "d/M/y",
                                                                              _model.datePicked5,
                                                                              locale: FFLocalizations.of(context).languageCode,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Stack(
                                                                    children: [
                                                                      TextFormField(
                                                                        controller:
                                                                            _model.dataMovimentacaoSaidaTextController ??=
                                                                                TextEditingController(
                                                                          text: _model.datePicked6 != null
                                                                              ...
                                                                              : dateTimeFormat(
                                                                                  "d/M/y",
                                                                                  pgRebanhoEditRebanhoRow?.movimentacaoSaida,
                                                                                  locale: FFLocalizations.of(context).languageCode,
                                                                                ),
                                                                        ),
                                                                        focusNode:
                                                                            _model.dataMovimentacaoSaidaFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        readOnly:
                                                                            true,
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          hintText: _model.datePicked6 != null
                                                                              ? dateTimeFormat(
                                                                                  "d/M/y",
                                                                                  _model.datePicked6,
                                                                                  locale: FFLocalizations.of(context).languageCode,
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.dataMovimentacaoSaidaTextController?.text =
                                                                                dateTimeFormat(
                                                                              "d/M/y",
                                                                              _model.datePicked6,
                                                                              locale: FFLocalizations.of(context).languageCode,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Stack(
                                                                    children: [
                                                                      TextFormField(
                                                                        controller:
                                                                            _model.dataMorteTextController ??=
                                                                                TextEditingController(
                                                                          text: _model.datePicked7 != null
                                                                              ...
                                                                              : dateTimeFormat(
                                                                                  "d/M/y",
                                                                                  pgRebanhoEditRebanhoRow?.dataMorte,
                                                                                  locale: FFLocalizations.of(context).languageCode,
                                                                                ),
                                                                        ),
                                                                        focusNode:
                                                                            _model.dataMorteFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        readOnly:
                                                                            true,
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.dataMorteTextController?.text =
                                                                                dateTimeFormat(
                                                                              "d/M/y",
                                                                              _model.datePicked7,
                                                                              locale: FFLocalizations.of(context).languageCode,
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        FlutterFlowDropDown<
                                                                            String>(
                                                                          controller: _model.dropDownMotivoMorteValueController ??=
                                                                              FormFieldController<String>(
                                                                            _model.dropDownMotivoMorteValue ??=
                                                                                valueOrDefault<String>(
                                                                              pgRebanhoEditRebanhoRow?.motivoMorte,
                                                                              '0',
                                                                            ),
                                                                          ),
                                                                          options: const [
                                                                          ...
                                                                          onChanged: (val) =>
                                                                              safeSetState(() => _model.dropDownMotivoMorteValue = val),
                                                                          height:
                                                                              56.0,
                                                                          textStyle: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Stack(
                                                                            children: [
                                                                              TextFormField(
                                                                                controller: _model.dataAcaoTextController1 ??= TextEditingController(
                                                                                  text: _model.datePicked8 != null
                                                                                      ...
                                                                                      : dateTimeFormat(
                                                                                          "d/M/y",
                                                                                          pgRebanhoEditRebanhoRow?.dataAcao,
                                                                                          locale: FFLocalizations.of(context).languageCode,
                                                                                        ),
                                                                                ),
                                                                                focusNode: _model.dataAcaoFocusNode1,
                                                                                autofocus: false,
                                                                                readOnly: true,
                                                                                obscureText: false,
                                                                                decoration: InputDecoration(
                                                                                  ...
                                                                                  hintText: _model.datePicked8 != null
                                                                                      ? dateTimeFormat(
                                                                                          "d/M/y",
                                                                                          _model.datePicked8,
                                                                                          locale: FFLocalizations.of(context).languageCode,
                                                                                ...
                                                                                cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                validator: _model.dataAcaoTextController1Validator.asValidator(context),
                                                                              ),
                                                                              InkWell(
                                                                                splashColor: Colors.transparent,
                                                                                focusColor: Colors.transparent,
                                                                                ...
                                                                                onTap: () async {
                                                                                  ...
                                                                                  safeSetState(() {
                                                                                    _model.dataAcaoTextController1?.text = dateTimeFormat(
                                                                                      "d/M/y",
                                                                                      _model.datePicked8,
                                                                                      locale: FFLocalizations.of(context).languageCode,
                                                                                    );
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Stack(
                                                                            children: [
                                                                              TextFormField(
                                                                                controller: _model.dataAcaoTextController2 ??= TextEditingController(
                                                                                  text: _model.datePicked9 != null
                                                                                      ...
                                                                                      : dateTimeFormat(
                                                                                          "d/M/y",
                                                                                          pgRebanhoEditRebanhoRow?.dataVenda,
                                                                                          locale: FFLocalizations.of(context).languageCode,
                                                                                        ),
                                                                                ),
                                                                                focusNode: _model.dataAcaoFocusNode2,
                                                                                autofocus: false,
                                                                                readOnly: true,
                                                                                obscureText: false,
                                                                                decoration: InputDecoration(
                                                                                  ...
                                                                                  hintText: _model.datePicked9 != null
                                                                                      ? dateTimeFormat(
                                                                                          "d/M/y",
                                                                                          _model.datePicked9,
                                                                                          locale: FFLocalizations.of(context).languageCode,
                                                                                ...
                                                                                cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                validator: _model.dataAcaoTextController2Validator.asValidator(context),
                                                                              ),
                                                                              InkWell(
                                                                                splashColor: Colors.transparent,
                                                                                focusColor: Colors.transparent,
                                                                                ...
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  final initialVenda = _model.datePicked9 ?? pgRebanhoEditRebanhoRow?.dataVenda ?? getCurrentTimestamp;
                                                                                  final datePickedVendaDate = await showDatePicker(
                                                                                    context: context,
                                                                                  ...
                                                                                  safeSetState(() {
                                                                                    _model.dataAcaoTextController2?.text = dateTimeFormat(
                                                                                      "d/M/y",
                                                                                      _model.datePicked9,
                                                                                      locale: FFLocalizations.of(context).languageCode,
                                                                                    );
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          height:
                                                                              56.0,
                                                                          child:
                                                                              custom_widgets.CurrencyInputBR2(
                                                                            width:
                                                                                double.infinity,
                                                                            height:
                                                                                56.0,
                                                                            initialValue:
                                                                                pgRebanhoEditRebanhoRow?.valorCompra,
                                                                            fillColor:
                                                                                FlutterFlowTheme.of(context).customColor2,
                                                                            borderColor:
                                                                                Colors.transparent,
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          height:
                                                                              56.0,
                                                                          child:
                                                                              custom_widgets.CurrencyInputBR(
                                                                            width:
                                                                                double.infinity,
                                                                            height:
                                                                                56.0,
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          controller: _model.anotacoesTextController ??=
                                                                              TextEditingController(
                                                                            text: pgRebanhoEditRebanhoRow?.anotacoes == 'null'
                                                                                ? 'N/A'
                                                                                : pgRebanhoEditRebanhoRow?.anotacoes,
                                                                          ),
                                                                          focusNode:
                                                                        ...
                                                                        Stack(
                                                                          children: [
                                                                            TextFormField(
                                                                              ...
                                                                              cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                              validator: _model.dataPesagemTextControllerValidator.asValidator(context),
                                                                            ),
                                                                            InkWell(
                                                                              splashColor: Colors.transparent,
                                                                              focusColor: Colors.transparent,
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                final datePicked10Date = await showDatePicker(
                                                                                  context: context,
                                                                                  initialDate: _model.datePicked10 ?? getCurrentTimestamp,
                                                                                  firstDate: DateTime(1900),
                                                                                  lastDate: DateTime(2050),
                                                                                  builder: (context, child) {
                                                                                    return wrapInMaterialDatePickerTheme(
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        TextFormField(
                                                                          controller:
                                                                              _model.pesoAddTextController,
                                                                          focusNode:
                                                                              _model.pesoAddFocusNode,
                                                                          autofocus:
                                                                              false,
                                                                          obscureText:
                                                                              false,
                                                                          ...
                                                                          cursorColor:
                                                                              FlutterFlowTheme.of(context).primaryText,
                                                                          validator: _model
                                                                              .pesoAddTextControllerValidator
                                                                              .asValidator(context),
                                                                        ),
                                                                      ].divide(const SizedBox(
                                                                              height: 8.0)),
                                                                      ...
                                                                      safeSetState(
                                                                        ...
                                                                        if (ultimaEdit !=
                                                                          ...
                                                                          _model
                                                                              ...
                                                                              ?.text = PesoDecimalInputFormatter.formatDouble(ultimaEdit.peso);
                                                                          _model.datePicked4 =
                                                                                  ...
                                                                                  FlutterFlowIconButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      if (confirmDialogResponse) {
                                                                                        ...
                                                                                        final ultimaPesagemAtiva = await _syncPesoAtualAposPesagem(
                                                                                          rebanhoId: pgRebanhoEditRebanhoRow?.id,
                                                                                          idRebanho: pgRebanhoEditRebanhoRow?.idRebanho,
                                                                                        );
                                                                                        safeSetState(() {
                                                                                          _model.requestCompleter = null;
                                                                                          _model.pesoAtualTextController?.text = PesoDecimalInputFormatter.formatDouble(ultimaPesagemAtiva?.peso);
                                                                                          _model.datePicked4 = ultimaPesagemAtiva?.dataPesagem;
                                                                                          _model.dataUltimaPesagemTextController?.text = ultimaPesagemAtiva?.dataPesagem != null
                                                                                              ? dateTimeFormat(
                                                                                                  "d/M/y",
