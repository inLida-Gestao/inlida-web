...
import 'cc_add_nascimento_model.dart';
export 'cc_add_nascimento_model.dart';

class CcAddNascimentoWidget extends StatefulWidget {
  const CcAddNascimentoWidget({
    super.key,
  ...
  @override
  State<CcAddNascimentoWidget> createState() => _CcAddNascimentoWidgetState();
}

class _CcAddNascimentoWidgetState extends State<CcAddNascimentoWidget>
    with TickerProviderStateMixin {
  late CcAddNascimentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CcAddNascimentoModel());
