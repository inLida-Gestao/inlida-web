...
import 'pg_rebanho_add_semen_model.dart';
export 'pg_rebanho_add_semen_model.dart';

class PgRebanhoAddSemenWidget extends StatefulWidget {
  const PgRebanhoAddSemenWidget({super.key});

  static String routeName = 'pgRebanhoAddSemen';
  static String routePath = '/addrebanhosemen';

  @override
  State<PgRebanhoAddSemenWidget> createState() =>
      _PgRebanhoAddSemenWidgetState();
}

class _PgRebanhoAddSemenWidgetState extends State<PgRebanhoAddSemenWidget> {
  late PgRebanhoAddSemenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgRebanhoAddSemenModel());
