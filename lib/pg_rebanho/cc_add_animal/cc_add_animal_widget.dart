...
import 'cc_add_animal_model.dart';
export 'cc_add_animal_model.dart';

class CcAddAnimalWidget extends StatefulWidget {
  const CcAddAnimalWidget({
    super.key,
  ...
  @override
  State<CcAddAnimalWidget> createState() => _CcAddAnimalWidgetState();
}

class _CcAddAnimalWidgetState extends State<CcAddAnimalWidget>
    with TickerProviderStateMixin {
  late CcAddAnimalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CcAddAnimalModel());
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            TextFormField(
                                              ...
                                              focusNode: _model.chipFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: false,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (containerRebanhoRowList
                                            ...
                                            FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .dropDownMatrizValueController ??=
                                                  FormFieldController<String>(
                                                _model.dropDownMatrizValue ??=
                                                    '',
                                              ),
                                              options: List<String>.from(
                                                  containerRebanhoRowList
                                                      .where((e) =>
                                                          (e.sexo == 'Fêmea') &&
                                                          (e.categoria !=
                                                              'Bezerra'))
