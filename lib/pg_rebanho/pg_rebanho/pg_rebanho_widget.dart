...
class _PgRebanhoWidgetState extends State<PgRebanhoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.buscaRebanhosIni?.succeeded ?? true)) {
        _model.rebanhosPage = ((_model.buscaRebanhosIni?.jsonBody ?? '')
                .toList()
      ...
      _model.qtdtesste =
          await FunctionsSupabaseRebanhoGroup.rebanhoPropriedadeCall.call(
        pIdPropriedade: FFAppState().propriedadeSelecionada.idPropriedade,
      );

      _model.qtdAnimais =
          await FunctionsSupabaseRebanhoGroup.qTDRebanhoPropriedadeCall.call(
        pIdPropriedade: FFAppState().propriedadeSelecionada.idPropriedade,
      );
