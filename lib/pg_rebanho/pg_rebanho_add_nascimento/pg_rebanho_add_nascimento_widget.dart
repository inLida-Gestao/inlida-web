...
import 'pg_rebanho_add_nascimento_model.dart';
export 'pg_rebanho_add_nascimento_model.dart';

class PgRebanhoAddNascimentoWidget extends StatefulWidget {
  const PgRebanhoAddNascimentoWidget({super.key});

  static String routeName = 'pgRebanhoAddNascimento';
  static String routePath = '/addrebanhonascimento';

  @override
  State<PgRebanhoAddNascimentoWidget> createState() =>
      _PgRebanhoAddNascimentoWidgetState();
}

class _PgRebanhoAddNascimentoWidgetState
    extends State<PgRebanhoAddNascimentoWidget> with TickerProviderStateMixin {
  late PgRebanhoAddNascimentoModel _model;
  ...
  void initState() {
    ...
    _model.dataVendaTextController1 ??= TextEditingController();
    _model.dataVendaFocusNode1 ??= FocusNode();

    _model.dataVendaTextController2 ??= TextEditingController();
    _model.dataVendaFocusNode2 ??= FocusNode();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.dataVendaTextController1?.text = dateTimeFormat(
            "d/M/y",
            _model.datePicked3,
            locale: FFLocalizations.of(context).languageCode,
          );
          _model.dataVendaTextController2?.text = dateTimeFormat(
            "d/M/y",
            _model.datePicked4,
            locale: FFLocalizations.of(context).languageCode,
          );
                                                            ...
                                                            children: [
                                                              ...
                                                              if (_model
                                                                ...
                                                                FlutterFlowDropDown<
                                                                    String>(
                                                                  controller: _model
                                                                      .dDCatRebanhoFemeaValueController ??= FormFieldController<
                                                                          String>(
                                                                      'Bezerra'),
                                                                  options: const [
                                                                    'Bezerra',
                                                              ...
                                                              if (_model
                                                                ...
                                                                FlutterFlowDropDown<
                                                                    String>(
                                                                  controller: _model
                                                                      .dDCatRebanhoMachoValueController ??= FormFieldController<
                                                                          String>(
                                                                      'Bezerro'),
                                                                  options: const [
                                                                    'Bezerro',
                                                              ...
                                                              TextFormField(
                                                                ...
                                                                cursorColor:
                                                                    FlutterFlowTheme.of(
                                                                        ...
                                                                        .primaryText,
                                                                validator: _model
                                                                    .dataVendaTextController1Validator
                                                                    .asValidator(
                                                                        context),
                                                              ),
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  safeSetState(
                                                                      () {
                                                                    _model.dataVendaTextController1
                                                                            ?.text =
                                                                        dateTimeFormat(
                                                                      "d/M/y",
                                                                      _model
                                                              ...
                                                              TextFormField(
                                                                ...
                                                                cursorColor:
                                                                    FlutterFlowTheme.of(
                                                                        ...
                                                                        .primaryText,
                                                                validator: _model
                                                                    .dataVendaTextController2Validator
                                                                    .asValidator(
                                                                        context),
                                                              ),
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  safeSetState(
                                                                      () {
                                                                    _model.dataVendaTextController2
                                                                            ?.text =
                                                                        dateTimeFormat(
                                                                      "d/M/y",
                                                                      _model
                                      ...
                                      FFButtonWidget(
                                        onPressed: _model.isSaving
                                            ...
                                            : () async {
                                                ...
                                                final pesoPesoNascimentoHist =
                                                    double.tryParse(_model
                                                        .pesoNascimentoTextController
                                                        .text
                                                        .replaceAll(',', '.'));
                                                if (pesoPesoNascimentoHist !=
                                                        null &&
