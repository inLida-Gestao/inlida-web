...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF28A365);
  late Color secondary = const Color(0xFF1E7A4C);
  late Color tertiary = const Color(0xFFBEBEBE);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF474747);
  late Color secondaryText = const Color(0xFF181818);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF28A365);
  late Color accent2 = const Color(0xFFB1CC29);
  late Color accent3 = const Color(0xFF8E8E8E);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFCC3729);
  late Color info = const Color(0xFFFFFFFF);

  late Color customColor1 = const Color(0xFF4E4133);
  late Color customColor2 = const Color(0xFFF1F1F1);
  late Color customColor3 = const Color(0xFF32CC7E);
  late Color customColor4 = const Color(0xFF232908);
  late Color customColor5 = const Color(0xFFEDEDED);
  late Color customColor6 = const Color(0xFF5F5F5F);
  late Color customColor7 = const Color(0xFFD6F5E5);
  late Color customColor8 = const Color(0xFFF8F8F8);
  late Color icon = const Color(0xFF5F5F5F);
  late Color customColor9 = const Color(0xFF2F2F2F);
  late Color customColor10 = const Color(0xFF145232);
  late Color customColor11 = const Color(0xFFF8F8F8);
  late Color customColor12 = const Color(0xFFBEBEBE);
}
