      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: AuthSplitLayout(
            wideFormMainAxisAlignment: MainAxisAlignment.center,
            wideFormTopPadding: 0.0,
            form: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.apiResulta5i = await FunctionsSupabaseRebanhoGroup
                          .validarAcessoUserCall
                          .call(
                        pUserId: currentUserUid,
                      );

                      if ((_model.apiResulta5i?.succeeded ?? true)) {
                        if (FunctionsSupabaseRebanhoGroup.validarAcessoUserCall
                                .acesso(
                              (_model.apiResulta5i?.jsonBody ?? ''),
                            ) ==
                            'Cancelado') {
                          GoRouter.of(context).prepareAuthEvent();
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(
                          PoliticaPrivacidadeTermosdeusoWidget.routeName);
                    },
                    child: Text(
