...
class InLidaWebSupabaseUser extends BaseAuthUser {
  InLidaWebSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> inLidaWebSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = InLidaWebSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
