                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await PiqueteTable().insert({
                                          'nome': _model
                                              .nomePiqueteTextController.text,
                                          ...
                                          'id_rebanhos': _model
                                              ...
                                              .whereType<String>()
                                              .toList(),
                                          'id_lotes': _model.lotesSelecionados
                                              .map((l) => l.idLote)
                                              .whereType<String>()
                                              .toList(),
                                          'id_piquete': idPiquete,
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    Text(' \u2022 ',
                        style: GoogleFonts.poppins(
                            fontSize: 14.0, color: const Color(0xFF474747))),
                    Text(
                ...
                Row(
                  children: [
                    Text(
                      animal.categoria.isNotEmpty ? animal.categoria : '-',
                      style: GoogleFonts.poppins(
                        fontSize: 14.0,
          ...
          child: _buildAnimalPanelCard(
            ...
            listContent: _model.animaisSelecionados.isEmpty
                ...
                : SizedBox(
                    height: 400.0,
                    child: ListView.builder(
                      itemCount: _model.animaisSelecionados.length,
                      itemBuilder: (context, i) {
                        final animal = _model.animaisSelecionados[i];
                        return _buildAnimalItem(
                          context,
                          animal,
                          checked:
