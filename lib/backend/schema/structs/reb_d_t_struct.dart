...
class RebDTStruct extends BaseStruct {
  RebDTStruct({
    int? id,
    String? createdAt,
  ...
  static RebDTStruct fromMap(Map<String, dynamic> data) => RebDTStruct(
  ...
  static RebDTStruct? maybeFromMap(dynamic data) =>
      data is Map ? RebDTStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static RebDTStruct fromSerializableMap(Map<String, dynamic> data) =>
      RebDTStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'RebDTStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is RebDTStruct &&
        id == other.id &&
