...
import 'menu_perfil_model.dart';
export 'menu_perfil_model.dart';

class MenuPerfilWidget extends StatefulWidget {
  const MenuPerfilWidget({super.key});

  @override
  State<MenuPerfilWidget> createState() => _MenuPerfilWidgetState();
}

class _MenuPerfilWidgetState extends State<MenuPerfilWidget> {
  late MenuPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuPerfilModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed(AlterarSenhaWidget.routeName);
                      },
                      child: Container(
                        width: double.infinity,
                        height: 72.0,
